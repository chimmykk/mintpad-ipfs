  ...
  return (
    ...
    >
      <Head>
        ...
        <meta
          name="description"
          content="Next.js app with MetaMask deployment"
        />
      ...
      <main
        style={{ padding: "40px 20px", textAlign: "center", width: "100%" }}
      >
        <h1
          style={{
            fontSize: "36px",
        ...
        >
          ...
          <p style={{ fontSize: "16px", color: "#777" }}>
            Choose a collection to upload. This section can be expanded with
      ...
      >
        <p style={{ fontSize: "14px", color: "#666" }}>
          MintPad 2024 Copyright All Rights Reserved
        </p>
      </footer>
    </div>
  );
